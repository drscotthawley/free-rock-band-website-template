...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    ...
    let domain = "scotthawley.com" ; // Update yours informations here
...
// Locations
$(function () {
    $(".card").on('click', () => {window.location.href = "https://www.instagram.com/thescotthawley/"});
})
// Location socials
$(function () {
    ...
    $('.instagram').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.instagram.com/thescotthawley/";
    });
})
