...
//
// Modified from Web Audio and 3D Soundscapes: Implementation
...
(function(){
	...
	function AudioPlayer() {
		...
		var m_this = this
		var m_context =  new(window.AudioContext || window.webkitAudioContext);
 //new AudioContext()
		...
		function onSoundEnded() {
			...
			if (is(m_this.onended, Function)) {
				m_this.onended(o.snd)
			}
		}
	}
